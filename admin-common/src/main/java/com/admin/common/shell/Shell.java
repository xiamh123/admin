...
import com.admin.common.shell.build.LinuxShellBuilder;
import com.admin.common.shell.build.WindowsShellBuilder;
        ...
        if (this.commands.size() > 1) {
            ...
            Process process = Runtime.getRuntime()
                    .exec(this.commands.toArray(new String[this.commands.size()])
                            , envp, dir);
            logger.info("********** 执行shell脚本耗时: " + String.valueOf(System.currentTimeMillis()-start));
